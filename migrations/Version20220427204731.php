 ...
 */
final class Version20220427204731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment_likes (id INT AUTO_INCREMENT NOT NULL, feedback_id INT DEFAULT NULL, INDEX IDX_E050D68CD249A887 (feedback_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE comment_likes ADD CONSTRAINT FK_E050D68CD249A887 FOREIGN KEY (feedback_id) REFERENCES feedback (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE feedback CHANGE commentaire commentaire VARCHAR(255) NOT NULL COLLATE `utf8mb4_general_ci`');
