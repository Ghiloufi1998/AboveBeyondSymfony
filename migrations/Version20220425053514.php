 ...
 */
final class Version20220425053514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE infousersondg DROP FOREIGN KEY infousersondg_ibfk_1');
        $this->addSql('DROP INDEX sondage_id ON infousersondg');
        $this->addSql('ALTER TABLE infousersondg ADD id INT AUTO_INCREMENT NOT NULL, CHANGE info_user_id info_user_id INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE infousersondg MODIFY id INT NOT NULL');
        $this->addSql('ALTER TABLE infousersondg DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE infousersondg DROP id, CHANGE info_user_id info_user_id INT AUTO_INCREMENT NOT NULL, CHANGE sexe sexe VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE pay pay VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE email email VARCHAR(30) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE infousersondg ADD CONSTRAINT infousersondg_ibfk_1 FOREIGN KEY (sondage_id) REFERENCES sondage (sondage_id)');
        $this->addSql('CREATE INDEX sondage_id ON infousersondg (sondage_id)');
        $this->addSql('ALTER TABLE infousersondg ADD PRIMARY KEY (info_user_id)');
