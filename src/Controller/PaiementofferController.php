...
class PaiementofferController extends AbstractController
{   
    /**
     * @Route("/userpai", name="app_pai_offer")
     */
    ...
    public function checkout($stripeSK): Response
    {
        ...
        $montant =$this->getDoctrine()->getRepository(Reservation::class)->montantoffr();
