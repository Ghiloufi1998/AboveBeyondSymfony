 ...
 * Reservation
 *
 * @ORM\Table(name="reservation", indexes={@ORM\Index(name="PK_heb", columns={"Hebergement_id"}), @ORM\Index(name="Fk", columns={"ID_user"}), @ORM\Index(name="PK_vol", columns={"vol_ID"})})
 * @ORM\Entity
 */
class Reservation
{
